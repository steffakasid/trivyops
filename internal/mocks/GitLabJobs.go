...
func (_c *GitLabJobs_DownloadArtifactsFile_Call) RunAndReturn(run func(interface{}, string, *gitlab.DownloadArtifactsFileOptions, ...gitlab.RequestOptionFunc) (*bytes.Reader, *gitlab.Response, error)) *GitLabJobs_DownloadArtifactsFile_Call {
	_c.Call.Return(run)
	return _c
}

// GetJobArtifacts provides a mock function with given fields: pid, jobID, options
func (_m *GitLabJobs) GetJobArtifacts(pid interface{}, jobID int, options ...gitlab.RequestOptionFunc) (*bytes.Reader, *gitlab.Response, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
...
func (_c *GitLabJobs_GetJobArtifacts_Call) Run(run func(pid interface{}, jobID int, options ...gitlab.RequestOptionFunc)) *GitLabJobs_GetJobArtifacts_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GitLabJobs_GetJobArtifacts_Call) Return(_a0 *bytes.Reader, _a1 *gitlab.Response, _a2 error) *GitLabJobs_GetJobArtifacts_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *GitLabJobs_GetJobArtifacts_Call) RunAndReturn(run func(interface{}, int, ...gitlab.RequestOptionFunc) (*bytes.Reader, *gitlab.Response, error)) *GitLabJobs_GetJobArtifacts_Call {
	_c.Call.Return(run)
	return _c
}

// ListPipelineJobs provides a mock function with given fields: pid, pipelineID, opts, options
func (_m *GitLabJobs) ListPipelineJobs(pid interface{}, pipelineID int, opts *gitlab.ListJobsOptions, options ...gitlab.RequestOptionFunc) ([]*gitlab.Job, *gitlab.Response, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
...
func (_c *GitLabJobs_ListPipelineJobs_Call) Run(run func(pid interface{}, pipelineID int, opts *gitlab.ListJobsOptions, options ...gitlab.RequestOptionFunc)) *GitLabJobs_ListPipelineJobs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]gitlab.RequestOptionFunc, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
...
func (_c *GitLabJobs_ListPipelineJobs_Call) Return(_a0 []*gitlab.Job, _a1 *gitlab.Response, _a2 error) *GitLabJobs_ListPipelineJobs_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *GitLabJobs_ListPipelineJobs_Call) RunAndReturn(run func(interface{}, int, *gitlab.ListJobsOptions, ...gitlab.RequestOptionFunc) ([]*gitlab.Job, *gitlab.Response, error)) *GitLabJobs_ListPipelineJobs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *GitLabJobs_ListProjectJobs_Call) RunAndReturn(run func(interface{}, *gitlab.ListJobsOptions, ...gitlab.RequestOptionFunc) ([]*gitlab.Job, *gitlab.Response, error)) *GitLabJobs_ListProjectJobs_Call {
	_c.Call.Return(run)
	return _c
}
