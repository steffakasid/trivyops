...
func (_c *GitLabGroups_ListGroupProjects_Call) RunAndReturn(run func(interface{}, *gitlab.ListGroupProjectsOptions, ...gitlab.RequestOptionFunc) ([]*gitlab.Project, *gitlab.Response, error)) *GitLabGroups_ListGroupProjects_Call {
	_c.Call.Return(run)
	return _c
}
